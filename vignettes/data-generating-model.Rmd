...
And so the power to detect a significant treatment effect in this scenario is 57% when using a $t$-test on per-subject means (which is close to the power reported by @Urach2019).
